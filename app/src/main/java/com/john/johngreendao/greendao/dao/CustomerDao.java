...
public class CustomerDao extends AbstractDao<Customer, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Like = new Property(4, String.class, "like", false, "LIKE");
    }
    ...
    public Customer readEntity(Cursor cursor, int offset) {
        Customer entity = new Customer( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4) // like
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Customer entity, int offset) {
        ...
        entity.setLike(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
     }
